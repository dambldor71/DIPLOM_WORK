                                                                ...
                                                                <ul>
                                                                    @foreach($filters as $value)
                                                                        @if($value['cid'] === $category['cid'])
                                                                            @if($num < 6)
                                                                                <li>
                                                                                    <a href="http://{{$_SERVER['HTTP_HOST']}}/catalog?{{$value['fid']}}={{$category['cid']}}&min-price=0&max-price={{Tender::pluck('price')->max()}}">{{$value['name']}}</a>
                                                                                </li>
                                                                                @php
                                                                                    $num += 1
                                                                                @endphp
                                                            ...
                                                            <li>
                                                                ...
                                                                <ul>
                                                                    @foreach($cat['value'] as $elem)
                                                                        <li>
                                                                            @if($key === 'Приоритет')
                                                                                <a href="http://{{$_SERVER['HTTP_HOST']}}/favourite-catalog?{{$cat['id']}}={{$elem->id}}&stage=all&min-price=0&max-price={{Tender::pluck('price')->max()}}">{{$elem->name}}</a>
                                                                            @else
                                                                                <a href="http://{{$_SERVER['HTTP_HOST']}}/favourite-catalog?priority=all&{{$cat['id']}}={{$elem->id}}&min-price=0&max-price={{Tender::pluck('price')->max()}}">{{$elem->name}}</a>
                                                                            @endif
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
