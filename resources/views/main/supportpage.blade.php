            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="frequently-area">
                        <h2 class="heading mb-0">Общие сведения по структуре веб-приложения</h2>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="frequently-item">
                                            <ul>
                                                <li class="has-sub active">
                                                    <a href="javascript:void(0)">Веб-приложение для поиска
                                                        <i class="pe-7s-angle-down"></i>
                                                    </a>
                                                    <ul class="frequently-body">
                                                        <li>
                                                            Веб-приложение PumoriTender предназначен для потбора и отслеживания интересующих тендеров, благодаря предоставляемому функционалу продукта.
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="has-sub">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            Предоставление данных осуществляется с помощью парсинга.
                                                            В веб-приложении есть возможность настроить частоту парсинга всех и избранных тендеров.
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="has-sub">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            ...
                                                            <br><br>
                                                            Веб-приложение специализирован на тендерах на поставку металлообрабатывающих станков и металлорежущего инструмента.
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="frequently-item">
                                            <ul>
                                                <li class="has-sub active">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            На странице "Личный кабинет" Вы можете ознакомиться со всеми тендерами, которые были добавлены в избранное, изменить их приоритет, этап работ.
                                                            Также веб-приложение позволяет отслеживать выигранные тендеры путём указания id участника тендера.
                                                            Также, на странице присутствует возможность сформировать отчёт по данной странице.
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="has-sub">
                                                    <a href="javascript:void(0)">Страница "Профиль"
                                                        <i class="pe-7s-angle-down"></i>
                                                    </a>
                                                    <ul class="frequently-body">
                                                        <li>
                                                            На странице "Профиль" Вы можете отредактировать данные пользователя, получить краткие сведения по работе с тендерами.
                                                            Присутствует возможность добавить и удалить приоритеты и этапы работ для тендеров, а также настроить частоту парсинга данных.
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="has-sub">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            Страница "Помощь" предоставляет краткую информацию по веб-приложению и работе с ним.
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="frequently-item">
                                            <ul>
                                                ...
                                                <li class="has-sub">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            ...
                                                            Если тендер добавлен в избранное, рядом будет указан приоритет, с которым данный тендер был добавлен.<br><br>
                                                ...
                                                <li class="has-sub">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            На странице "Личный кабинет" пользователь может сформировать выгрузку в формате Excel, указав необходимые данные для выгрузки и то, какие тендеры необходимо добавить в выгрузку.
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="frequently-item">
                                            <ul>
                                                ...
                                                <li class="has-sub">
                                                    <a href="javascript:void(0)">Отображение результатов проведения тендеров
                                                        <i class="pe-7s-angle-down"></i>
                                                    </a>
                                                    <ul class="frequently-body">
                                                        <li>
                                                            Выигранные тендеры подсвечиваются зелёным цветом. Это означает, что ваш идентификационный номер занял 1-ое место в результатах отбора.<br><br>
                                                            Тендеры, статус которых говорит о завершении или отмена проведения, подсвечиваются красным цветом.
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="has-sub">
                                                    ...
                                                    <ul class="frequently-body">
                                                        <li>
                                                            Во вкладке "Профиль" в разделе "Статистика" Вы можете ознакомиться со статистикой профиля.
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
